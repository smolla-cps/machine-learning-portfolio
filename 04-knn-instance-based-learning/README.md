...
This version retains the distinct technical material represented across the supplied k-NN sources, including:

- explicit basic and distance-weighted k-NN workflows
- synthetic decision-boundary experiments
- MNIST input/output problem framing
- zero and majority-class baselines
- one-nearest-neighbor implementation from scratch
- vectorized distance-matrix implementation
- Fashion-MNIST comparison
- class-mean prototype compression
- neighbor-vote confidence analysis
- targeted \(k=1,5,10\) comparison
- broader neighborhood-size sweeps
- uniform vs. distance weighting
- Manhattan vs. Euclidean distance
- constant-pixel feature reduction
- brute-force, KD-tree, and Ball-tree search
- California Housing k-NN regression
- manual and library-based feature scaling
- custom weighted k-NN regression
- four distance-computation strategies
- brute-force and efficient multi-\(k\) evaluation
- the identified extension of efficient multi-\(k\) evaluation to classification

Repeated templates, duplicate executions, course identifiers, submission instructions, and other classroom-only material are intentionally excluded.
